...
tf.app.flags.DEFINE_integer('embedding_size', 512, 'embedding size')  # 가중치 크기 # 논문 512 사용
...
tf.app.flags.DEFINE_integer('layer_size', 6, 'layer size')  # 논문은 6개 레이어이나 2개 사용 학습 속도 및 성능 튜닝
...
tf.app.flags.DEFINE_boolean('xavier_initializer', True, 'set xavier initializer')  # Xavier Init(가중치 초기화 알고리즘) 사용 여부
